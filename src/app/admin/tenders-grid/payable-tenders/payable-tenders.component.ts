...
@Component({
  selector: 'app-payable-tenders',
  templateUrl: './payable-tenders.component.html',
  styleUrls: ['./payable-tenders.component.css']
})
export class PayableTendersComponent implements OnInit {
  ...
  getPayableRecords() {
    ...
    this.tenderservice.getPayablerecords(tenderdata1.id).subscribe((data: any) => {
      if (data) {
