...
@Component({
  selector: 'app-transaction-details-recieve',
  templateUrl: './transaction-details-recieve.component.html',
  styleUrls: ['./transaction-details-recieve.component.css']
})
export class TransactionDetailsRecieveComponent implements OnInit{
  transactionMode: any = '';
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    ...
    private dialogRef: MatDialogRef<TransactionDetailsRecieveComponent>,
  ...
  ngOnInit(): void {
    ...
    //     }
    // });
        console.log("data",this.data.transactionType);  
  ...
  onSubmit(){
    ...
    this.transactionDetails.isRefundable=true;
   
    if (this.transactionDetails) {
    this.tenderservice.postReceivetransactiondetails(tenderdata1.id,this.transactionDetails).subscribe((data:any)=>{
